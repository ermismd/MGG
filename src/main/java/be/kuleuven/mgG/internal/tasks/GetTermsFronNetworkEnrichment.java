...
public class GetTermsFronNetworkEnrichment extends AbstractTask {
	    ...
	    public void run(TaskMonitor taskMonitor) {   // throws Exception 
		        ...
		        taskMonitor.showMessage(TaskMonitor.Level.INFO, "phendb:"+phendbAttributeList.toString());
		        
		        System.out.println("HELLO FRIEND");
		        taskMonitor.showMessage(TaskMonitor.Level.INFO, "Hello friend");
		        
		        taskMonitor.showMessage(TaskMonitor.Level.INFO, "faprotaxAttributeList:"+faprotaxAttributeList.toString());
