...
import uni.kul.rega.mgG.internal.api.DoubleMatrix;
...
import uni.kul.rega.mgG.internal.model.ScNVSettings.SETTING;
import uni.kul.rega.mgG.internal.sources.file.FileSource;
import uni.kul.rega.mgG.internal.sources.file.tasks.FileCategoryTask;
import uni.kul.rega.mgG.internal.sources.file.tasks.FileCategoryTaskFactory;
import uni.kul.rega.mgG.internal.tasks.AbstractEmbeddingTask;
import uni.kul.rega.mgG.internal.tasks.CalculateDETask;
import uni.kul.rega.mgG.internal.tasks.ExportCSVTask;
import uni.kul.rega.mgG.internal.tasks.RemoteGraphTask;
import uni.kul.rega.mgG.internal.tasks.RemoteTSNETask;
import uni.kul.rega.mgG.internal.tasks.RemoteUMAPTask;
import uni.kul.rega.mgG.internal.tasks.tSNETask;
import uni.kul.rega.mgG.internal.utils.CyPlotUtils;
